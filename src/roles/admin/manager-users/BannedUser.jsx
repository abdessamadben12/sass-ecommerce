...
import { deleteUsers, getBannedUser } from '../../../services/ServicesAdmin/userServices';
...
export default function BannedUser() {
    ...
    useEffect( () => {
        const fetchData = async () => {
            setLoading(true)
            const data=await getBannedUser(currentPage,perPage,role,inputSerch,setMessaheError)
    ...
    function handleRole(role){
      ...
      const handledelete=async(id) =>{
        await getBannedUser(currentPage,perPage,role,inputSerch,setMessaheError)
